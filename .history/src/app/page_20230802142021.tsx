...
export default function Page() {
  ...
  <div>
      ...
      height={600}
          ...
          <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 33 33" fill="none">
          ...
          </svg><svg xmlns="http://www.w3.org/2000/svg" width="69" height="69" viewBox="0 0 69 69" fill="none">
