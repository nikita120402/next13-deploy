...
export default function Page() {
  ...
  <circle cx="30.5" cy="30.5" r="33.5" fill="white" stroke="#222831" stroke-width="2"/>
  <svg xmlns="http://www.w3.org/2000/svg" width="60" height="55" viewBox="0 0 30 30" fill="none">
